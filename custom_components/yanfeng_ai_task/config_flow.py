...
class YanfengAISubentryFlowHandler(ConfigSubentryFlow):
    ...
    async def async_step_set_options(
        ...
        if self.source == "user":
            ...
            elif self._subentry_type == "conversation":
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        CONF_CUSTOM_CHAT_MODEL,
                        description={"suggested_value": options.get(CONF_CUSTOM_CHAT_MODEL, "")},
                    ): TextSelector(
                        TextSelectorConfig(type=TextSelectorType.TEXT)
                    ),
                    vol.Optional(
                    ...
                    vol.Optional(
                        CONF_CUSTOM_IMAGE_MODEL,
                        description={"suggested_value": options.get(CONF_CUSTOM_IMAGE_MODEL, "")},
                    ): TextSelector(
                        TextSelectorConfig(type=TextSelectorType.TEXT)
                    ),
                    vol.Optional(
